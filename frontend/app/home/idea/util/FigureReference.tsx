// Patent_Survey_APP/frontend/app/home/idea/util/FigureReference.tsx
...
export const FigureReference = ({
    ...
    const target = images.find((img) => img.label === `図${figureNo}`);

    if (!target) {
        return <span className="text-slate-400">[図:{figureNo}]</span>;
    }
